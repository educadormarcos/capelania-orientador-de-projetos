# Proteção e liberdade religiosa

## Planejamento seguro

Identifique responsável institucional pela proteção, equipe supervisionada, regras para atendimentos em locais visíveis com privacidade de escuta, entrada e saída, transporte e contatos digitais. Obtenha as autorizações institucionais e dos responsáveis exigidas pelo contexto; respeite também a recusa e o assentimento da criança conforme seu desenvolvimento. Autorização não elimina limites éticos.

Não use contas pessoais ou mensagens secretas para acompanhar menores. Defina canais institucionais, registros mínimos, acesso restrito e critérios de retenção. Imagens e relatos exigem análise específica e autorização cabível; não presuma que autorização para participar inclui divulgação. Não publique vulnerabilidades ou dados identificáveis em campanhas, testemunhos ou pedidos de oração.
...
Não prometa segredo absoluto, faça investigação, confronte o suspeito ou tente mediação entre criança e possível agressor. Preserve registros mínimos e factuais por canais protegidos, sem solicitar ao usuário nomes, imagens ou detalhes identificáveis no chat. Não contate automaticamente familiares que possam estar envolvidos ou aumentar o risco.
...
| Proposta problemática | Alternativa responsável |
|---|---|
| Oração obrigatória na escola | Atividade de convivência acessível; eventual momento confessional separado, permitido e voluntário |
| Cesta básica após participação no culto | Assistência com critérios públicos de necessidade; convite religioso separado e sem contrapartida |
| Amizade para obter conversões | Presença e cuidado transparentes, mantidos diante de recusa religiosa |
| Lista escolar para convites de igreja | Não reutilizar contatos; comunicação pelos canais autorizados e adesão específica quando cabível |
| Criança contou abuso e pediu segredo | Acolher, explicar limites do sigilo e acionar proteção sem investigação própria |

Consultar fontes oficiais atualizadas antes de afirmar requisitos legais específicos. Se não houver acesso, identifique a verificação pendente e não declare regularidade jurídica. As salvaguardas de cuidado continuam aplicáveis ao rascunho.
